...
<form method="post" action="{{route('store.team')}}" enctype="multipart/form-data">
    ...
    <div class="col-lg-6">
              <div class="form-group ">
                ...
                <input name="phone_no" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" >
          ...
          <div class="col-lg-6">
              <div class="form-group ">
                ...
                <input name="facebook" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" >
            ...
            <div class="col-lg-6">
              <div class="form-group ">
                ...
                <input name="youtube" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" >
              ...
              <div class="form-group ">
                ...
                <input name="instagram" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" >
         ...
         <div class="col-lg-6">
              <div class="form-group ">
                ...
                <input name="twitter" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" >

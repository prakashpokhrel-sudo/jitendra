  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="card-header card-header-primary">
            <div class="row">
            <div class="col-md-10">
            <h4 class="card-title ">Edit Review Page</h4>
...
<div class="card pd-20 pd-sm-40 ">
         <strong> <h6 style="padding: 20px 0 20px 10px; " class="card-body-title">Team Details</h6> </strong>
          <br>
<form method="post" action="{{route('update.review.list',$reviewedit->id)}}" enctype="multipart/form-data">
    @csrf()
          <div class="row">
    ...
    <div class="col-lg-6">
              <div class="form-group ">
                ...
                <input name="name" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" value="{{$reviewedit->name}}" >
    ...
    <div class="col-lg-6">
              <div class="form-group ">
                ...
                <input name="desc" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" value="{{$reviewedit->desc}}" >
          ...
          <div class="col-lg-6">
              <div class="form-group ">
                ...
                <input name="profile" style="padding: 0px 0 0px 10px;"  class="form-control " placeholder="Enter The Title " type="text" value="{{$reviewedit->profile}}">
          ...
          <img style="padding: 0px 0 100px 10px;" width="300px;" height="300px;"  src="{{asset('images/reviews/'.$reviewedit->review_image)}}" id="one" style="center">
            </label>
